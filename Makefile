...
compare_array_list_and_linked_list: compare_array_list_and_linked_list.cpp array_list.cpp linked_list.cpp
	c++ -std=c++14 compare_array_list_and_linked_list.cpp -o compare_array_list_and_linked_list

compare_array_list_and_linked_list.o: compare_array_list_and_linked_list.cpp array_list.cpp linked_list.cpp
